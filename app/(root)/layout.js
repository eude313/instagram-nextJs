...
export default function RootLayout({ children }) {
  ...
  return (
    <main className='flex flex-row relative'>
      <ProgressBar />
      <aside
        className={`border-r px-[12px] border-[#DBDBDB] shrink hidden md:block z-10 
      ...
      <div className='w-full md:w-fit h-screen z-1 flex-1 overflow-y-auto'>
        {children}
      </div>
      ...
      <CreateStory isScreenSmall={isScreenSmall} />
      <CreatePost isScreenSmall={isScreenSmall} />
      <AuthModal />
    </main>
  );
}
